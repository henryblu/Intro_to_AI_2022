...
def main():
    ...
    NOTE 1: You can use predefined State class or return any object (including str itself) as long as it has
    ...
    NOTE 2: This program differs from the TravelPlanner program as it uses an additional metric of distance in conjunction with the A* algorithm for a much more efficient search.
    """
